...
API_ID = int(environ.get('API_ID', '6311947127'))
API_HASH = environ.get('API_HASH', '741de90023a0d7bfc8c06bc3fd362ba2')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1735612964').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001862654253').split()]
